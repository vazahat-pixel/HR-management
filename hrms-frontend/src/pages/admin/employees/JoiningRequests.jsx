                        ...
                        <div className="bg-white p-5 rounded-2xl border border-[#DCDCDC] shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                <div>
                                    ...
                                    <input type="text" id="customEmployeeId" placeholder="Alphanumeric ID" autoComplete="new-password" className="w-full h-[42px] bg-[#F5F5F5] border border-[#DCDCDC] rounded-xl px-4 text-[11px] font-bold text-slate-900 focus:outline-none focus:border-[#C46A2D] tracking-wider" />
                                </div>
                                <div>
